...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> HealthCare </h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> HealthCare </a>
...
<div class="col-md-4"><label>Are you</label></div>
<div class="col-md-8">
    <select name="maritalStatus" class="form-control">
        <option value="married">Married</option>
        <option value="divorced">Divorced</option>
        <option value="single">Single</option>
        <option value="significantPartnership">Significant partnership</option>
...
<div class="col-md-8">
    <select name="maritalStatus" class="form-control">
        <option value="married">Govt Employee</option>
        <option value="divorced">Private Employee</option>
        <option value="single">Farmer</option>
        <option value="significantPartnership">House Wife</option>
        <option value="widowed">BusinessMan</option>
    </select>
</div><br><br>
<div class="col-md-4"><label>Employer</label></div>
<div class="col-md-8">
    <select name="maritalStatus" class="form-control">
...
<div class="col-md-4"><label>Insurancce Plan</label></div>
<div class="col-md-8">
    <select name="maritalStatus" class="form-control">
        <option value="married">Yes</option>
        <option value="divorced">No</option>
...
<div class="col-md-8">
    <div class="form-group">
        <input type="text" class="form-control" name="mohalla" placeholder="Mohalla/Street/Building Name">
    </div>
    <div class="form-group">
        <input type="text" class="form-control" name="sector" placeholder="Sector (if applicable)">
    </div>
    <div class="form-group">
...
<div class="col-md-4"><label>Emergency Contact Person</label></div>
<div class="col-md-8">
    <input type="text" class="form-control" name="emergencyContact" placeholder="Emergency Contact Person">
</div><br><br>

<div class="col-md-4"><label>How did you hear about us?</label></div>
<div class="col-md-8">
    <select name="howDidYouHear" class="form-control">
...
<div class="col-md-4"><label>Live with</label></div>
<div class="col-md-8">
    <select name="howDidYouHear" class="form-control">
        <option value="website">Spouse</option>
        <option value="friend">Parents</option>
        <option value="socialMedia">Children</option>
        <option value="advertisement">Significant</option>
    ...
    <legend>Talk to the Doctor about Therapies</legend>

        <div class="col-md-4"><label>Would you like to talk to the doctor about any of the following therapies?</label></div>
        <div class="col-md-8">
            <select id="therapies" name="therapies[]" class="form-control">
                ...
                <option value="herbalMedicine">Herbal Medicine</option>
            </select>
    </div><br><br>
<br>
...
<div class="row">
    <div class="col-md-4"><label>What are your most important health concerns/symptoms? Please begin with the MOST IMPORTANT to address today.</label></div>
    <div class="col-md-8">
        <textarea class="form-control" name="healthConcerns"></textarea>
    </div>
</div>
<br><br>  
<div>
        ...
        <input type="time" name="apptime" required><br><br>
        <label for="docFees">Doctor's Fees:</label>
        <input type="number" name="docFees" required><br><br>
           
<div><br><br>

<div class="col-md-4"><label>Additional Details</label></div>
<div class="col-md-8">
    <textarea class="form-control" name="additionalDetails" placeholder="Please provide more details if applicable"></textarea>
</div><br><br>
